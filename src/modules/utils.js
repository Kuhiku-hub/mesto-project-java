...
export const popupProfileOpenButton = profile.querySelector(".profile__edit-button");
...
export const inactiveButtonClass = popupForm.querySelector('.popup__submit_inactive')
// popup - profile
